// import {getRandomArray, getRandomNum} from "./utils.js";
...
//     destination: {
//       name: cityValues[Math.floor(Math.random() * cityValues.length)],
...
// export const tripInfoData = getTripInfoData(eventsData.slice().sort((a, b) => a - b));
